...
public class MongoDBDataStoreUtilities {
    ...
    public static String insertReview(String productname, String username, String producttype, String productmaker, String reviewrating, String reviewdate, String reviewtext, String retailerpin, String price, String retailercity,String usergender,String retailerstate,String useroccupatation) {
        try {
            getConnection();
            BasicDBObject doc = new BasicDBObject("title", "myReviews").
                    ...
                    append("useroccupatation", useroccupatation).
        ...
        try {
            ...
            while (cursor.hasNext()) {
                ...
                Review review = new Review(obj.getString("productName"), obj.getString("userName"), obj.getString("productType"), obj.getString("productMaker"),
                        obj.getString("reviewRating"), obj.getString("reviewDate"), obj.getString("reviewText"), obj.getString("retailerpin"), obj.getString("price"), obj.getString("retailercity"),obj.getString("retailerstate"),obj.getString("usergender"),obj.getString("useroccupatation"));
