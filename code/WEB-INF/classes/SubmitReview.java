		...
		if(!utility.isLoggedin()){
			...
			return;
				...
				String usergender = request.getParameter("usergender");
					String useroccupatation = request.getParameter("useroccupatation");
		String message=utility.storeReview(productname,producttype,productmaker,reviewrating,reviewdate,reviewtext,retailerpin,productprice,retailercity,retailerstate,usergender,useroccupatation);
