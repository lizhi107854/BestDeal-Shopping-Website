...
public class ProductRecommenderUtility{
	...
	public static String getConnection()
	{
		...
		try
		{
			...
			conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/HW2database","root","19940510");
			message="Successfull";
			return message;
		}
	...
	public HashMap<String,String> readOutputFile(){
		...
		try {
            ...
            br = new BufferedReader(new FileReader(new File("/Users/zhili/IdeaProjects/hw2_lz/web/output.csv")));
