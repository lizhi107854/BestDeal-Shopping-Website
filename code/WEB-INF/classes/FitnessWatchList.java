	...
	/* Checks the Tablets type whether it is microsft or apple or samsung */
		...
		for (Map.Entry<String, FitnessWatch> entry : hm.entrySet()) {
			...
			pw.print("<li><form method='post' action='Cart'>" +
					"<input type='hidden' name='name' value='"+fitnessWatch.getName()+"'>"+
			...
			pw.print("<li><form method='post' action='WriteReview'>"+"<input type='hidden' name='name' value='"+fitnessWatch.getName()+"'>"+
					"<input type='hidden' name='type' value='fitnessWatches'>"+
					"<input type='hidden' name='maker' value='"+CategoryName+"'>"+
					"<input type='hidden' name='price' value='"+fitnessWatch.getPrice()+"'>"+
					"<input type='hidden' name='access' value=''>"+
				    "<input type='submit' value='WriteReview' class='btnreview'></form></li>");
			pw.print("<li><form method='post' action='ViewReview'>"+"<input type='hidden' name='name' value='"+fitnessWatch.getName()+"'>"+
					"<input type='hidden' name='type' value='fitnessWatches'>"+
					"<input type='hidden' name='maker' value='"+CategoryName+"'>"+
					"<input type='hidden' name='price' value='"+fitnessWatch.getPrice()+"'>"+
					"<input type='hidden' name='access' value=''>"+
